    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content radius-xl">
            <div class="modal-header">
                <h6 class="modal-title fw-500" id="staticBackdropLabel">Sửa loại xe</h6>
            ...
            <div class="modal-body">
                <div class="new-member-modal">
                    <form method="POST" action="" id="editTypecar">
                        @csrf
                        <div class="d-flex new-member-calendar">
                            <div class="form-group w-100 form-group-calender" id="nameTypeInput">
                            </div>
                        </div>

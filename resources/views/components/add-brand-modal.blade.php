        ...
        <div class="modal-content radius-xl">
            ...
            <div class="modal-body">
                <div class="new-member-modal">
                    <form method="POST" action="{{ url('/them-thuong-hieu') }}" id="addBrand">
                        @csrf
                        ...
                        <div class="d-flex new-member-calendar">
                            <div class="form-group w-100">
                                <div class="countryOption">
                                    ...
                                    <select form="addBrand" name="nations"
                                        class="js-example-basic-single js-states form-control" id="nations">
                                    </select>
                                </div>
                            </div>
                        </div>

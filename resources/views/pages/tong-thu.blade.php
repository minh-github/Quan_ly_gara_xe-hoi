            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb-main">
                        <h4 class="text-capitalize breadcrumb-title">Tài chính</h4>
                                ...
                                <table class="table-borderless mb-0 table">
                                    <thead>
                                        <tr class="userDatatable-header">
                                            <th>
                                                <span class="userDatatable-title">Mã số</span>
                                            </th>
                                            <th>
                                                <span class="userDatatable-title">loại thu</span>
                                            </th>
                                            <th>
                                                <span class="userDatatable-title">giá trị</span>
                                            </th>
                                            <th>
                                                <span class="userDatatable-title">ngày thu</span>
                                            </th>
                                            <th class="actions">
                                                <span class="userDatatable-title">tùy chọn</span>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="userDatatable-content--subject">
                                                        {{ number_format($item->TienThue) }} VND
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="userDatatable-content--subject">

                    ...
                    <div class="breadcrumb-main user-member justify-content-sm-between">
                        <div class="d-flex justify-content-center breadcrumb-main__wrapper flex-wrap">
                            <div class="d-flex align-items-center user-member__title justify-content-center me-sm-25">
                                <h4 class="text-capitalize fw-500 breadcrumb-title">Danh sách thương hiệu</h4>
                        ...
                        <div class="action-btn">
                            <a href="#" class="btn px-15 btn-primary" data-bs-toggle="modal"
                                ...
                                <i class="las la-plus fs-16"></i>Thêm thương hiệu</a>
                            @include('components.add-brand-modal')
                            @include('components.edit-brand-modal')
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="media py-30 ps-30 pe-20 radius-xl users-list bg-white">
                            <div class="media-body d-xl-flex users-list-body">
                                <div class="pe-xl-30 users-list-body__title flex-1">
                                    <h6 class="fw-500 mt-0">{{ $brand->TenThuongHieu }}</h6>
                                    <p class="mb-0">{{ $brand->nation->TenQuocGia }}</p>
                                </div>
                                <div class="d-flex users-list__button mt-xl-0 mt-15">
                                    <ul class="orderDatatable_actions d-flex mb-0 flex-wrap">
                                        <li>
                                            <a href="#" onclick="editBrand(event,{{ $brand->id }})" class="edit">
                                                <i class="uil uil-edit"></i>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ url('/xoa-thuong-hieu/' . $brand->id) }}" class="remove">
...
@endsection
@section('js')
    <script src="{{ url('js/edit-brand.js') }}"></script>
    <script src="{{ url('js/nations.js') }}"></script>
@endsection

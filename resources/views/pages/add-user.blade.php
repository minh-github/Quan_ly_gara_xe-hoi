@extends('layouts.header-register')
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ url('/them-tai-khoan') }}" id="register">
                            @csrf
                            <div class="row mb-3">
                                <label for="name"
                            ...
                            <div class="row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    ...
                                    <a href="/danh-sach-user" class="btn btn-warning">
                                        {{ __('Thoát thêm người dùng') }}
                                    </a>
                                </div>
                            </div>
                        </form>

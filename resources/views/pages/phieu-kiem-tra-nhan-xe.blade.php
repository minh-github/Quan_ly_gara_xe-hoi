...
@section('content')
    <div class="contents">
        ...
        <div class="container-fluid">
            <div class="row">
                <form action="{{ url('/luu-phieu-kiem-tra-nhan-xe/' . $backCheck->id) }}" method="POST" id="formKiemTra">
                    @csrf
                    <div class="product-add global-shadow px-sm-30 py-sm-50 radius-xl w-100 mb-40 bg-white px-0 py-20">
                        <div class="row justify-content-center">
                            {{-- <div class="mb-30 row">
                                <div class="card-header">
                                    <h6 class="fw-500 h3">Danh sách kiểm tra trước đó</h6>
                                </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="add-product__body px-sm-40 px-20">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control TenPhuTung" disabled
                                                        placeholder="lốp xe,..." value="{{ $item->TenThietBi }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                            ...
                            <div class="mb-30 row" id="danhSachPhuTung">
                                ...
                                @foreach ($frontCheck->detail as $item)
                                    <div class="row" style="background: #f1f1f1">
                                        <div class="col-lg-5">
                                            <div class="add-product__body px-sm-40 px-20">
                                                <div class="form-group">
